...
PRETRAINED_MODEL_DIR = os.path.join(PROJECT_DIR, 'pretrained_models', 'chinese-roberta-wwm-ext')
...
# 输出路径
# =========================
OUTPUT_DIR = os.path.join(PROJECT_DIR, 'outputs_roberta_base_chinese')
