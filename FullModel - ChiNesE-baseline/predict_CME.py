# -*- coding: utf-8 -*-
"""
ChiNesE 预测脚本：兼容当前旧版 GlobalPointer 模型。

输出：
1. outputs_ChiNesE/ChiNesE_predict_entities.json：entities 列表，便于人工检查；
2. outputs_ChiNesE/ChiNesE_predict_result.jsonl：ChiNesE 常见 label 字典格式。
"""
import os
import json
import random
...
if __name__ == '__main__':
    ...
    entity_out = os.path.join(OUTPUT_DIR, 'ChiNesE_predict_entities.json')
    chinese_out = os.path.join(OUTPUT_DIR, 'ChiNesE_predict_result.jsonl')
