...
DEV_FILE = 'new_eval.json'
TEST_FILE = 'new_test.json'

# 数据集名称：'CMeEE-V2'、'CLUENER' 或 'ChiNesE'。
# ChiNesE/new_* 数据格式为 JSONL：{'id','text','label'}，span 为闭区间 [start, end]。
...
# ChiNesE/new_test 是有标签测试集；eval_test.py 会固定验证集最优阈值评估 test。
...
# ChiNesE / new_* 数据集标签。注意：样例中使用 Creature；如原数据出现 Organisms，data_loader 会映射到 Creature。
CHINESE_LABEL_DESCRIPTIONS = {
    'Person': '人物姓名、人物称谓、角色名或人物相关实体',
    'Location': '地点、地名、行政区划、地理位置或场所',
    'Organization': '组织机构、公司、学校、团队或其他机构实体',
    'Time': '时间、日期、朝代、时期或时刻表达',
    'Work': '作品名称，书籍、影视、游戏、文章或文艺作品',
    'Food': '食物、菜品、饮品或食品相关实体',
    'Product': '产品、商品、工具、设备或品牌产品实体',
    'Medicine': '药物、药品、治疗用药或药品名称',
    'Event': '事件、比赛、活动、历史事件或事件名称',
    'Creature': '生物、动物、植物或其他生命体实体',
}
