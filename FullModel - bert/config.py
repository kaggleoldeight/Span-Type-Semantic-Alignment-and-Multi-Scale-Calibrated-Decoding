...
- 保留 AutoModel/BiGRU/GlobalPointer/PGD 主链路；
...
# 切换 CLUENER 时通常需要同时修改 TRAIN_FILE/DEV_FILE/TEST_FILE。
...
# 输出路径
# =========================
OUTPUT_DIR = os.path.join(PROJECT_DIR, 'outputs_bert_base_chinese')
...
# =========================
# 与此前 CNN adapter 不同，本模块不改写 AutoModel->BiGRU->GlobalPointer 主干。
# 它从 预训练模型多个 hidden layer 取表示，训练一个轻量 auxiliary GlobalPointer 分支，
